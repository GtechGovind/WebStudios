<footer id="footer">
            ...
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-lg-6">
                     ...
                     <form action="https://t.me/WebStudios2020" method="post">
            ...
            <div class="container">
               <div class="row">
                  <div class="col-lg-3 col-md-6 footer-contact">
                     <h3>WebStudios</h3>
                     <p>
                        Bldg no 85/A201 Nehru Nagar, <br>
                        Kurla (E), Mumbai-400024, Mumbai, <br>
                        Maharashtra 400024 <br>
                        <strong>Phone:</strong> +91 7977 1928 75<br>
         ...
         <div class="container footer-bottom clearfix">
            <div class="copyright">
               &copy; Copyright <strong><span>MaQueenSoft</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
               ...
               Designed by <a href="https://WebStudios.store/">WebStudios.store</a>
            </div>
         </div>
      </footer>
      <!-- End Footer -->
      ...
      <!-- Global site tag (gtag.js) - Google Analytics -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-4T6G2Z6KMG"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
        
          gtag('config', 'G-4T6G2Z6KMG');
        </script>