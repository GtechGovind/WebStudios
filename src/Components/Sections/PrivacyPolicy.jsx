        ...
        <>
            <section>
                <div className="en section_container active" section-language="en">
                    <div id="md_en" data-target="out_en" className="agreement_md"><h1>Privacy Policy</h1>
                        <p className = "text-justify">Last updated: May 31, 2021</p>
                        <p className = "text-justify">This Privacy Policy describes Our policies and procedures on the collection, use and
                            disclosure of Your information when You use the Service and tells You about Your privacy
                            rights and how the law protects You.</p>
                        <p className = "text-justify">We use Your Personal data to provide and improve the Service. By using the Service, You agree
                            ...
                            Privacy Policy has been created with the help of the <a
                                href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank">Privacy
                                Policy Generator</a>.</p>
                        <h1>Interpretation and Definitions</h1>
                        <h2>Interpretation</h2>
                        <p className = "text-justify">The words of which the initial letter is capitalized have meanings defined under the
                        ...
                        <ul>
                            <li>
                                <p className = "text-justify"><strong>Account</strong> means a unique account created for You to access our Service
                                    or parts of our Service.</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Affiliate</strong> means an entity that controls, is controlled by or is
                            ...
                            <li>
                                <p className = "text-justify"><strong>Application</strong> means the software program provided by the Company
                                    downloaded by You on any electronic device, named WebStudios and Apps</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
                                    this Agreement) refers to WebStudios.</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Cookies</strong> are small files that are placed on Your computer, mobile
                            ...
                            <li>
                                <p className = "text-justify"><strong>Country</strong> refers to: Maharashtra, India</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Device</strong> means any device that can access the Service such as a
                                    computer, a cellphone or a digital tablet.</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Personal Data</strong> is any information that relates to an identified or
                                    identifiable individual.</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Service</strong> refers to the Application or the Website or both.</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Service Provider</strong> means any natural or legal person who processes the
                            ...
                            <li>
                                <p className = "text-justify"><strong>Third-party Social Media Service</strong> refers to any website or any social
                                    network website through which a User can log in or create an account to use the
                                    Service.</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Usage Data</strong> refers to data collected automatically, either generated
                                    by the use of the Service or from the Service infrastructure itself (for example,
                                    the duration of a page visit).</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Website</strong> refers to WebStudios, accessible from <a
                                    href="https://webstudios.store/" rel="external nofollow noopener"
                                    target="_blank">https://webstudios.store</a></p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>You</strong> means the individual accessing or using the Service, or the
                        ...
                        <h3>Personal Data</h3>
                        <p className = "text-justify">While using Our Service, We may ask You to provide Us with certain personally identifiable
                        ...
                        <p className = "text-justify">Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP
                            ...
                            diagnostic data.</p>
                        <p className = "text-justify">When You access the Service by or through a mobile device, We may collect certain information
                            ...
                            data.</p>
                        <p className = "text-justify">We may also collect information that Your browser sends whenever You visit our Service or
                            when You access the Service by or through a mobile device.</p>
                        <h3>Information from Third-Party Social Media Services</h3>
                        <p className = "text-justify">The Company allows You to create an account and log in to use the Service through the
                        ...
                        <p className = "text-justify">If You decide to register through or otherwise grant us access to a Third-Party Social Media
                        ...
                        <p className = "text-justify">You may also have the option of sharing additional information with the Company through Your
                        ...
                        <p className = "text-justify">While using Our Application, in order to provide features of Our Application, We may collect,
                        ...
                        <p className = "text-justify">We use this information to provide features of Our Service, to improve and customize Our
                        ...
                        <p className = "text-justify">You can enable or disable access to this information at any time, through Your Device
                            settings.</p>
                        <h3>Tracking Technologies and Cookies</h3>
                        <p className = "text-justify">We use Cookies and similar tracking technologies to track the activity on Our Service and
                        ...
                        <p className = "text-justify">Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal
                            computer or mobile device when You go offline, while Session Cookies are deleted as soon as
                            You close Your web browser. Learn more about cookies: <a
                                href="https://www.freeprivacypolicy.com/blog/cookies/" target="_blank">Cookies: What Do
                                They Do?</a>.</p>
                        <p className = "text-justify">We use both Session and Persistent Cookies for the purposes set out below:</p>
                        <ul>
                            <li>
                                <p className = "text-justify"><strong>Necessary / Essential Cookies</strong></p>
                                <p className = "text-justify">Type: Session Cookies</p>
                                <p className = "text-justify">Administered by: Us</p>
                                <p className = "text-justify">Purpose: These Cookies are essential to provide You with services available through
                            ...
                            <li>
                                <p className = "text-justify"><strong>Cookies Policy / Notice Acceptance Cookies</strong></p>
                                <p className = "text-justify">Type: Persistent Cookies</p>
                                <p className = "text-justify">Administered by: Us</p>
                                <p className = "text-justify">Purpose: These Cookies identify if users have accepted the use of cookies on the
                                    Website.</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>Functionality Cookies</strong></p>
                                <p className = "text-justify">Type: Persistent Cookies</p>
                                <p className = "text-justify">Administered by: Us</p>
                                <p className = "text-justify">Purpose: These Cookies allow us to remember choices You make when You use the
                        ...
                        <p className = "text-justify">For more information about the cookies we use and your choices regarding cookies, please
                        ...
                        <ul>
                            <li>
                                <p className = "text-justify"><strong>To provide and maintain our Service</strong>, including to monitor the usage
                                    of our Service.</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>To manage Your Account:</strong> to manage Your registration as a user of the
                                    Service. The Personal Data You provide can give You access to different
                                    functionalities of the Service that are available to You as a registered user.</p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>For the performance of a contract:</strong> the development, compliance and
                            ...
                            <li>
                                <p className = "text-justify"><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or
                            ...
                            <li>
                                <p className = "text-justify"><strong>To provide You</strong> with news, special offers and general information
                            ...
                            <li>
                                <p className = "text-justify"><strong>To manage Your requests:</strong> To attend and manage Your requests to Us.
                                </p>
                            </li>
                            <li>
                                <p className = "text-justify"><strong>For business transfers:</strong> We may use Your information to evaluate or
                            ...
                            <li>
                                <p className = "text-justify"><strong>For other purposes</strong>: We may use Your information for other purposes,
                        ...
                        <p className = "text-justify">We may share Your personal information in the following situations:</p>
                        <ul>
                        ...
                        <p className = "text-justify">The Company will retain Your Personal Data only for as long as is necessary for the purposes
                        ...
                        <p className = "text-justify">The Company will also retain Usage Data for internal analysis purposes. Usage Data is
                        ...
                        <p className = "text-justify">Your information, including Personal Data, is processed at the Company's operating offices
                        ...
                        <p className = "text-justify">Your consent to this Privacy Policy followed by Your submission of such information
                            represents Your agreement to that transfer.</p>
                        <p className = "text-justify">The Company will take all steps reasonably necessary to ensure that Your data is treated
                        ...
                        <p className = "text-justify">If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
                        ...
                        <p className = "text-justify">Under certain circumstances, the Company may be required to disclose Your Personal Data if
                        ...
                        <p className = "text-justify">The Company may disclose Your Personal Data in the good faith belief that such action is
                            necessary to:</p>
                        <ul>
                        ...
                        <p className = "text-justify">The security of Your Personal Data is important to Us, but remember that no method of
                            transmission over the Internet, or method of electronic storage is 100% secure. While We
                            strive to use commercially acceptable means to protect Your Personal Data, We cannot
                            guarantee its absolute security.</p>
                        <h1>Children's Privacy</h1>
                        <p className = "text-justify">Our Service does not address anyone under the age of 13. We do not knowingly collect
                            ...
                            from Our servers.</p>
                        <p className = "text-justify">If We need to rely on consent as a legal basis for processing Your information and Your
                        ...
                        <p className = "text-justify">Our Service may contain links to other websites that are not operated by Us. If You click on
                        ...
                        <p className = "text-justify">We have no control over and assume no responsibility for the content, privacy policies or
                            practices of any third party sites or services.</p>
                        <h1>Changes to this Privacy Policy</h1>
                        <p className = "text-justify">We may update Our Privacy Policy from time to time. We will notify You of any changes by
                            posting the new Privacy Policy on this page.</p>
                        <p className = "text-justify">We will let You know via email and/or a prominent notice on Our Service, prior to the change
                            becoming effective and update the "Last updated" date at the top of this Privacy Policy.</p>
                        <p className = "text-justify">You are advised to review this Privacy Policy periodically for any changes. Changes to this
                            Privacy Policy are effective when they are posted on this page.</p>
                        <h1>Contact Us</h1>
                        <p className = "text-justify">If you have any questions about this Privacy Policy, You can contact us:</p>
                        <ul>
                            <li>
                                <p className = "text-justify">By email: gtech.govind2000@gmail.com</p>
                            </li>
                            <li>
                                <p className = "text-justify">By visiting this page on our website: <a href="https://webstudios.store/contact"
                                                                            rel="external nofollow noopener"
                                                                            target="_blank">https://webstudios.store/contact</a>
                                </p>
                            </li>
                            <li>
                                <p className = "text-justify">By phone number: 7977192875</p>
                            </li>
                            <li>
                                <p className = "text-justify">By mail: Kamgar Nagr Kurla, Mumbai Maharashtra 24, India</p>
                            </li>
                        </ul>
                    </div>
